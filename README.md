...
> 若需本地编译、参与开发或维护发布，请先阅读 [维护者上手](docs/maintainer-onboarding.md)，再按需查看 [构建指南](docs/build-guide.md) 和 [开发工作流](docs/dev-workflow.md)。
...
* 想要贡献代码或接手维护？请先阅读 [维护者上手](docs/maintainer-onboarding.md) 与 [代码贡献指南](CONTRIBUTING.md)，然后提交 Pull Request。
