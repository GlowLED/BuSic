...
5. [20-workflows/dev-workflow.md](./20-workflows/dev-workflow.md)

### 改具体系统时

- 播放 / 队列 / 本地缓存：先看 [10-project/project-overview.md](./10-project/project-overview.md)
- 搜索 / 视频详情 / 解析链路：先看 [10-project/bilibili-integration.md](./10-project/bilibili-integration.md)
...
- 其中测试维护的主真源是 `20-workflows/testing-guide.md`。
...
- 自动化测试维护真源： [20-workflows/testing-guide.md](./20-workflows/testing-guide.md)
