...
class $SongsTable extends Songs with TableInfo<$SongsTable, Song> {
  ...
  static const VerificationMeta _originTitleMeta = const VerificationMeta(
    'originTitle',
  );
  @override
  ...
  static const VerificationMeta _originArtistMeta = const VerificationMeta(
    'originArtist',
  );
  @override
  ...
  static const VerificationMeta _customArtistMeta = const VerificationMeta(
    'customArtist',
  );
  @override
  ...
  Song map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Song(
      ...
      originTitle: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}origin_title'],
      )!,
      originArtist: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}origin_artist'],
      )!,
      customTitle: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}custom_title'],
      ),
      customArtist: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}custom_artist'],
      ),
...
class Song extends DataClass implements Insertable<Song> {
  ...
  Song copyWith({
    ...
    customArtist: customArtist.present ? customArtist.value : this.customArtist,
  ...
  Song copyWithCompanion(SongsCompanion data) {
    return Song(
      ...
      originTitle: data.originTitle.present
          ? data.originTitle.value
          : this.originTitle,
...
class $UserSessionsTable extends UserSessions
  ...
  static const VerificationMeta _sessdataMeta = const VerificationMeta(
    'sessdata',
  );
  @override
  ...
  static const VerificationMeta _biliJctMeta = const VerificationMeta(
    'biliJct',
  );
  @override
  ...
  static const VerificationMeta _dedeUserIdMeta = const VerificationMeta(
    'dedeUserId',
  );
  @override
  ...
  UserSession map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserSession(
      ...
      sessdata: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sessdata'],
      )!,
      biliJct: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bili_jct'],
      )!,
      dedeUserId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}dede_user_id'],
      )!,
...
class UserSession extends DataClass implements Insertable<UserSession> {
  ...
  UserSession copyWithCompanion(UserSessionsCompanion data) {
    return UserSession(
      ...
      dedeUserId: data.dedeUserId.present
          ? data.dedeUserId.value
          : this.dedeUserId,
...
class $SubtitlesTable extends Subtitles
  ...
  static const VerificationMeta _subtitleJsonMeta = const VerificationMeta(
    'subtitleJson',
  );
  @override
  ...
  Subtitle map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Subtitle(
      ...
      subtitleJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}subtitle_json'],
      )!,
...
final class $$SongsTableReferences
  ...
  _downloadTasksRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.downloadTasks,
    aliasName: 'songs__id__download_tasks__song_id',
  );
...
final class $$DownloadTasksTableReferences
  ...
  static $SongsTable _songIdTable(_$AppDatabase db) =>
      db.songs.createAlias('download_tasks__song_id__songs__id');
