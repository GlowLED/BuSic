...
/// 版本清单 — 所有历史版本及多渠道下载链接
@freezed
abstract class VersionManifest with _$VersionManifest {
...
/// 单个版本条目
@freezed
abstract class VersionEntry with _$VersionEntry {
...
/// 某个平台的下载资产（包含各渠道链接）
@freezed
abstract class PlatformAssets with _$PlatformAssets {
  const factory PlatformAssets({String? github, LanzouAsset? lanzou}) =
      _PlatformAssets;
...
/// 蓝奏云下载资产
@freezed
abstract class LanzouAsset with _$LanzouAsset {
  const factory LanzouAsset({required String url, String? password}) =
      _LanzouAsset;
