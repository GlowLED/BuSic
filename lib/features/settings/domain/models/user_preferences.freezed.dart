...
@useResult
$Res call({
 ThemeMode themeMode, String? locale, String? cachePath, int preferredQuality, int themeSeedColor, bool playbackFadeEnabled, int playbackFadeDurationMs, String? backgroundImagePath, double backgroundImageOpacity, double backgroundImageBlur
});
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? themeMode = null,Object? locale = freezed,Object? cachePath = freezed,Object? preferredQuality = null,Object? themeSeedColor = null,Object? playbackFadeEnabled = null,Object? playbackFadeDurationMs = null,Object? backgroundImagePath = freezed,Object? backgroundImageOpacity = null,Object? backgroundImageBlur = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String? locale,  String? cachePath,  int preferredQuality,  int themeSeedColor,  bool playbackFadeEnabled,  int playbackFadeDurationMs,  String? backgroundImagePath,  double backgroundImageOpacity,  double backgroundImageBlur)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.themeMode,_that.locale,_that.cachePath,_that.preferredQuality,_that.themeSeedColor,_that.playbackFadeEnabled,_that.playbackFadeDurationMs,_that.backgroundImagePath,_that.backgroundImageOpacity,_that.backgroundImageBlur);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String? locale,  String? cachePath,  int preferredQuality,  int themeSeedColor,  bool playbackFadeEnabled,  int playbackFadeDurationMs,  String? backgroundImagePath,  double backgroundImageOpacity,  double backgroundImageBlur)  $default,) {final _that = this;
switch (_that) {
case _UserPreferences():
return $default(_that.themeMode,_that.locale,_that.cachePath,_that.preferredQuality,_that.themeSeedColor,_that.playbackFadeEnabled,_that.playbackFadeDurationMs,_that.backgroundImagePath,_that.backgroundImageOpacity,_that.backgroundImageBlur);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  String? locale,  String? cachePath,  int preferredQuality,  int themeSeedColor,  bool playbackFadeEnabled,  int playbackFadeDurationMs,  String? backgroundImagePath,  double backgroundImageOpacity,  double backgroundImageBlur)?  $default,) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.themeMode,_that.locale,_that.cachePath,_that.preferredQuality,_that.themeSeedColor,_that.playbackFadeEnabled,_that.playbackFadeDurationMs,_that.backgroundImagePath,_that.backgroundImageOpacity,_that.backgroundImageBlur);case _:
  return null;
...
class _UserPreferences implements UserPreferences {
  const _UserPreferences({this.themeMode = ThemeMode.system, this.locale, this.cachePath, this.preferredQuality = 0, this.themeSeedColor = 0xFF4CAF50, this.playbackFadeEnabled = true, this.playbackFadeDurationMs = 1000, this.backgroundImagePath, this.backgroundImageOpacity = 0.5, this.backgroundImageBlur = 0});
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? themeMode = null,Object? locale = freezed,Object? cachePath = freezed,Object? preferredQuality = null,Object? themeSeedColor = null,Object? playbackFadeEnabled = null,Object? playbackFadeDurationMs = null,Object? backgroundImagePath = freezed,Object? backgroundImageOpacity = null,Object? backgroundImageBlur = null,}) {
